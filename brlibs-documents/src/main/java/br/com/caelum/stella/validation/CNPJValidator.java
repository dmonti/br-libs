...
public class CNPJValidator implements Validator < String > {
    ...
    /**
     * Este considera, por padrão, que as cadeias não estão formatadas e utiliza
     * um {@linkplain SimpleMessageProducer} para geração de mensagens.
     */
    ...
    /**
     * <p>
     * Construtor do Validador de CNPJ. Leva em consideração se o valor está
     * formatado.
     * </p>
     * <p>
     * 
